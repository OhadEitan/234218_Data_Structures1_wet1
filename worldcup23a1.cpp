    ...
    try
    {
        ...
        if (new_team->data->t_total_players >= 11 && new_team->data->t_gk_counter >0)
        {
            ...
            else
            {
                ...
                {
                    if (capable_team_before_specific->data->p_twc_list_capable->next != new_team->data->p_twc_list_capable || capable_team_before_specific->data->p_twc_list_capable->next == nullptr)
                    {
